...
#saber mais sobre a função com p ? na frente
?head
...
#como selecionar dados usando R DPLYR Q EH MUITO USADO PRA SELECIONAR DATA FRAMES
install.packages("dplyr")
library(dplyr)
...
# O %>% SERVE PARA ADD MAIS DE UMA CONDIÇÃO AO UMA FUNÇÃO
...
# OUTRA BIBLIOTECA IMPORTANTE NO R O TIDYR SERVE PRA MANIPULAR E TRANSFORMAR DADOS
#COMO SEPARAR, JUNTAR...
#Tidyr
...
#ACRESCENTENDO DIA
dfDate3$Dia <- c('15','16','17')
dfDate3

dfDate3 <- dfDate3 %>%
  unite(Data, Mes, Ano, Dia, sep = '/')
